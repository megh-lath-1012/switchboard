...
public class SwitchboardProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val containers = resolver.getSymbolsWithAnnotation("dev.meghlath.switchboard.annotations.Flags")
    ...
    private fun generateAccessors(container: KSClassDeclaration, flags: List<FlagMetadata>) {
        ...
        val switchboardClassName = ClassName("dev.meghlath.switchboard.core", "Switchboard")
    ...
    private fun generateAggregator() {
        val flagsFileSpec = FileSpec.builder("dev.meghlath.switchboard", "SwitchboardFlags")
            .addFileComment("GENERATED CODE — DO NOT EDIT")
        ...
        val registryClassName = ClassName("dev.meghlath.switchboard.core", "SwitchboardRegistry")
        val registeredFlagClassName = ClassName("dev.meghlath.switchboard.core", "RegisteredFlag")
        val flagTypeClassName = ClassName("dev.meghlath.switchboard.core", "FlagType")
        ...
        val registryFileSpec = FileSpec.builder("dev.meghlath.switchboard", "SwitchboardRegistryImpl")
            .addFileComment("GENERATED CODE — DO NOT EDIT")
